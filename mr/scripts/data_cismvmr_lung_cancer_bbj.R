...
unique(cancer_data1$trait)
cancer_data2<-cancer_data1[cancer_data1$trait=="Lung cancer" & cancer_data1$study=="BJ",]
...
data_list<-prep_data_eas2(Dat=fads1)
...
fads1_data<-format_results(gtex=FALSE,drop_palindromic_SNPs=TRUE)
...
save(Dat,file="~/fatty-acids/mr/data/data_for_cismvmr_lung_cancer_bj.RData")
