...
# chb (chinese from Beijing reference panel) and jpt (japan) ("Nort East Asian") from 1000 genomes n=207
...
write.table(Res,"~/fatty-acids/mr/results/cismvMR_crc_accc_chb_jpt.txt",sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
# j<-1
for (j in 1:7) {
