...
Plot_dat<-format_plot(dat=Dat,cancer=c("Basal cell carcinoma"   ))
dim(Plot_dat)
...
png("~/fatty-acids/mr/results/plots/metaforest_bcc_secondary_pufas_univariableMR_v4.png", width = 1000, height = 700)
...
# png("~/fatty-acids/mr/results/plots/ggforest_bcc_secondary_pufas_univariableMR_v3.png", width = 600, height = 700)
# 	print(P5) 
# dev.off()

# png("~/fatty-acids/mr/results/plots/ggforest_bcc_secondary_pufas_univariableMR_v3_nsnps.png", width = 600, height = 700)
# 	print(P4) 
# dev.off()

# png("~/fatty-acids/mr/results/plots/ggforest_bcc_secondary_pufas_univariableMR_v3_pval.png", width = 600, height = 700)
# 	print(P2) 
# dev.off()

# png("~/fatty-acids/mr/results/plots/ggforest_bcc_secondary_pufas_univariableMR_v3_Q_pval.png", width = 600, height = 700)
# 	print(P3) 
# dev.off()
