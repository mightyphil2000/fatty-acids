...
# chb (Chinese from Beijin) from 1000 genomes n=103
...
Res$panel<-"JPT"
write.table(Res,"~/fatty-acids/mr/results/cismvMR_escc_jpt_results.txt",sep="\t",col.names=TRUE,row.names=FALSE,quote=FALSE)
