...
snplist<-make_snplist(trait=traits,ref1000G_superpops=TRUE,snplist_user=Dat2$rsid)
...
Plot3<-make_plot_gwas_catalog(dat=Dat,trait=traits,beta="beta",se="se",force_all_trait_study_hits=TRUE)
