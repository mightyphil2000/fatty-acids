...
length(top_hits)
gc_list2<-find_hits_in_gwas_catalog(gwas_hits=top_hits$rsid,trait=traits,distance_threshold=200000)
# top_hits[,c("rsid","chr")]
...
Plot3<-make_plot_gwas_catalog(dat=Dat,trait=traits,beta="beta",se="se",force_all_trait_study_hits=TRUE,distance_threshold=175000)
