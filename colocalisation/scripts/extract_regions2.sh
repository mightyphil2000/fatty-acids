#!/usr/bin/env bash
#to run: extract_regions2.sh bash_input_gtex4.txt

InputDir='/projects/MRC-IEU/research/data/broad/public/gtex/released/2020-03-09/data/v8_eQTL_all_associations/'
