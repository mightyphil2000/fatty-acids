...
coloc_results<-colocalisation(
	...
	coloc_strategy="allcancers_1trait", #Which coloc strategy to use. 
	# allcancers_1trait will include all cancers and 1 fatty acid trait. 	
	...
	gene=NULL #which gene region to analyse?  FADS1,FADS2,ELOVL2 and SCD are accepted
	)
...
colocalisation<-function(cancer1=NULL,cancer2=NULL,gwis=NULL,ref_dat=NULL,
	coloc_strategy=NULL,turn_off_plot=FALSE,ref_turn_off=FALSE,region=NULL,gene=NULL){
