...
labels_colour<-unique(Nstudies2)
values_colour<-unique(Nstudies2)
values_colour[values_colour == "<5 studies" ]<-"red"
values_colour[values_colour ==  "5-10 studies" ]<-"orange"
values_colour[values_colour ==  "10-14 studies" ]<-"blue"
values_colour[values_colour ==  ">14 studies" ]<-"black"
...
png("~/fatty-acids/outcome_data/results/plots/predicted_lnor/accc3.png",width=500,height=500)
	ggplot2::ggplot(dat) + ggplot2::geom_point(ggplot2::aes(x=X, y=Y,colour=Nstudies2))+ ggplot2::ggtitle(Title) +ggplot2::labs(y= Ylab, x =Xlab,subtitle=subtitle) + ggplot2::theme(plot.title = ggplot2::element_text(size = Title_size, face = "plain"))+
			...
			ggplot2::scale_colour_manual(name = "N studies",
...
png("~/fatty-acids/outcome_data/results/plots/predicted_lnor/accc3_bias.png",width=500,height=500)
	ggplot2::ggplot(dat) + ggplot2::geom_point(ggplot2::aes(x=X, y=Y,colour=Nstudies2))+ ggplot2::ggtitle(Title) +ggplot2::labs(y= Ylab, x =Xlab,subtitle=subtitle) + ggplot2::theme(plot.title = ggplot2::element_text(size = Title_size, face = "plain"))+
				ggplot2::theme(axis.title=ggplot2::element_text(size=Title_xaxis_size))+
			ggplot2::scale_colour_manual(name = "N studies",
		labels = labels_colour,
