...
Model1<-summary(lm(Y~X,dat[Bias < 31 ,]))
...
subtitle<-paste0("intercept=",round(int1,3)," | ","slope=",round(slope1,3)," (Bias<31%)","\nintercept=",round(int2,3)," | ","slope=",round(slope2,3)," (All SNPs)")
...
values_colour[values_colour==">31"]<-"red"
values_colour[values_colour=="<31"]<-"black"
...
png("~/fatty-acids/outcome_data/results/plots/predicted_lnor/mnc_97.png",width=500,height=500)
