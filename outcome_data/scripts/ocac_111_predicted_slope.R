...
Model1<-summary(lm(Y~X,dat[Bias < 25 ,]))
...
subtitle<-paste0("intercept=",round(int1,3)," | ","slope=",round(slope1,3)," (Bias<25%)","\nintercept=",round(int2,3)," | ","slope=",round(slope2,3)," (All SNPs)")
...
png("~/fatty-acids/outcome_data/results/plots/predicted_lnor/ocac111.png",width=500,height=500)
