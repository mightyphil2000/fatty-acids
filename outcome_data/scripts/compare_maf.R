...
make_cow_plot2(width=1300,height=1000,Title_axis_size=0,bycols=FALSE,
		...
		Ylab="",
		Xlab="",
		out_file=paste0("~/fatty-acids/outcome_data/results/plots/eaf_vs_mafref/cowplot_schs_preqc.png"))
...
make_cow_plot2(width=1700,height=1100,Title_axis_size=0,bycols=FALSE,
		...
		Ylab="",
		Xlab="",
		out_file=paste0("~/fatty-acids/outcome_data/results/plots/eaf_vs_mafref/cowplot_eur_all_1000G_preqc3.png"))
